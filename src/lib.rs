...
mod commit_log;
mod commit_log_author_filter_widgets;
mod commit_log_column;
mod commit_log_filters;
mod commit_log_filters_combo_box;
mod commit_log_filters_view;
mod commit_log_model;
mod commit_log_model_filter;
mod commit_log_save_filter_button;
mod commit_log_save_filter_dialog;
mod commit_log_selections_comparer;
mod commit_log_show_filter_button;
mod commit_log_summary_filter_widgets;
mod commit_log_text_filter_widgets;
mod commit_log_view;
mod commit_message;
