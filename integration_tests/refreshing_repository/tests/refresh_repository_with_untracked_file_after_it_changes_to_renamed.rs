...
use common::file_changes_view_utils::{makeFileChange, makeRenamedFileChange};
...
use common::setup::{makeCommit, makeGui, makeNewUnstagedFile, renameFile, setupTest, stageFile};
